...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <form action="chpassu.php" class="formulario" id="formulariopassch" method="post">

      <!-- Grupo: Nombre -->
      <div class="formulario__grupo" id="grupo__pass">
        <label for="pass" class="formulario__label"></label>
        <div class="formulario__grupo-input">
          <input type="password" class="formulario__input" name="passch" id="passch" placeholder="Nueva contraseña">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
        </div>
        <p class="formulario__input-error">El pass tiene que ser de 4 a 30 Caracteres.</p>
      </div>
      ...
      <div class="formulario__grupo" id="grupo__pass">
        <label for="pass" class="formulario__label"></label>
          <div class="formulario__grupo-input">
            <input type="password" class="formulario__input" name="passre" id="passre" placeholder="Vuelva a introducir la contraseña">
            <i class="formulario__validacion-estado fas fa-times-circle"></i>
          </div>
        <p class="formulario__input-error">El pass tiene que ser de 4 a 30 Caracteres.</p>
      </div>
    ...
    <script src="../asset/js/formchpass.js"></script>
